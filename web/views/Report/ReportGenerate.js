  ...
  renderPurchase() {
    ...
    return (
        ...
        <tr>
          ...
          <td style={tdStyle}>PlaSkin</td>
          <td style={tdStyle}>1</td>
          <td style={tdStyle}>0</td>
          <td style={tdStyle}>1</td>
          <td style={tdStyle}>0</td>
          <td style={tdStyle}>299</td>
        </tr>
        <tr>
          <td style={tdStyle}>2</td>
          <td style={tdStyle}>PlaSkin Plus</td>
          ...
          <Row>
            <Col xs="12" lg="12">
              <Card style={{marginBottom: 15 + 'px'}}>
                <CardHeader>
                  {/*<Form inline>
                    <FormGroup className="pr-1 mb-2">
                      <Label htmlFor="exampleInputEmail2" className="pr-1">리포트 유형</Label>
                      <div style={{width: 780 + 'px'}}>
                  ...
                  <Form inline>
                    <FormGroup className="pr-1">
                      ...
                      <Input type="text" id="exampleInputEmail2" required/>
                    </FormGroup>
                    <FormGroup className="pr-1">
